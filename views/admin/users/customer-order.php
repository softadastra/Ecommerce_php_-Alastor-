...
$orderedArticles = $params['commandesClient'] ?? [];
...
<?php if (!empty($orderedArticles)) : ?>
    <div class="container mt-3">
        <h2 class="section-title">Commandes de mes Clients</h2>
        <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="article-details">
                                ...
                                <p class="card-text">Prix unitaire: <?= number_format($article->getPriceUnit(), 2) ?>$</p>
